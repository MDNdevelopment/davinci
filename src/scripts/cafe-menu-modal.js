          ...
          subs: [
            {
              name: 'Empanadas',
              items: [
                { name: 'Horneadas',  price: '$3,85', img: '/img/cafe/menu/empanada-horneada.webp', desc: 'Maíz y ricotta, espinaca o ricotta de pollo.' },
                { name: 'Integrales', price: '$3,85', img: '/img/cafe/menu/empanada-integral.webp', desc: 'Maíz y ricotta, espinaca o ricotta de pollo.' },
              ],
            },
            {
              name: 'Cachitos',
              items: [
                { name: 'Pavo y queso crema', price: '$5,00', img: '/img/cafe/menu/cachito-pavo-queso-crema.webp' },
                { name: 'Tres quesos',        price: '$3,50', img: '/img/cafe/menu/cachito-tres-quesos.webp' },
                { name: 'Jamón ahumado',      price: '$2,00', img: '/img/cafe/menu/cachitos-jamon-ahumado.webp' },
                { name: 'Jamón y Queso',      price: '$2,50', img: '/img/cafe/menu/cachito-jamon-y-queso.webp' },
              ],
            },
            {
              name: 'Hojaldres',
              items: [
                { name: 'Jamón y queso crema', price: '$5,15', img: '/img/cafe/menu/hojaldre-jamon-queso-crema.webp' },
                { name: 'Pollo',               price: '$4,00', img: '/img/cafe/menu/hojaldre-pollo.webp' },
                { name: 'Jamón y queso',       price: '$4,25', img: '/img/cafe/menu/hojaldre-jamon-y-queso.webp' },
              ],
            },
          ],
        },
          ...
          subs: [
            {
              ...
              items: [
                { name: 'Té negro',                 price: '$2,50', img: '/img/cafe/menu/te-negro.webp' },
                { name: 'Té negro con parchita',    price: '$2,75', img: '/img/cafe/menu/te-negro-parchita.webp' },
                { name: 'Frutos rojos',             price: '$2,50', img: '/img/cafe/menu/te-frutos-rojos.webp' },
                { name: 'Frutos rojos con parchita',price: '$2,75', img: '/img/cafe/menu/infusion-frutos-rojos-parchita.webp' },
                { name: 'Limonada',                 price: '$2,85', img: '/img/cafe/menu/limonada.webp' },
                { name: 'Limonada con menta',       price: '$3,00', img: '/img/cafe/menu/limonada-menta.webp' },
              ],
            },
            {
            ...
            },
            {
              ...
              items: [
                { name: 'Jugo de naranja', price: '$4,00', img: '/img/cafe/menu/jugo-naranja.webp' },
                { name: 'Fresa',           price: '$4,00', img: '/img/cafe/menu/jugo-fresa.webp' },
                { name: 'Melón',           price: '$3,00', img: '/img/cafe/menu/jugo-melon.webp' },
                { name: 'Piña',            price: '$4,00', img: '/img/cafe/menu/jugo-pina.webp' },
                { name: 'Jugo Verde',      price: '$4,00', img: '/img/cafe/menu/jugo-verde.webp', desc: 'Piña, célery, espinacas, pepino, jengibre y hierbabuena.' },
              ],
            },
            {
              name: 'Otras Bebidas',
              items: [
                { name: 'Agua mineral 300ml',   price: '$1,50', img: '/img/cafe/menu/agua-mineral.webp' },
                { name: 'Agua Sparkling 500ml', price: '$2,75', img: '/img/cafe/menu/agua-sparkling.webp' },
                { name: 'Pepsi Regular',        price: '$2,95', img: '/img/cafe/menu/pepsi-regular.webp' },
                { name: 'Pepsi Light',          price: '$2,95', img: '/img/cafe/menu/pepsi-light.webp' },
                { name: 'Pepsi Zero',           price: '$2,95', img: '/img/cafe/menu/pepsi-zero.webp' },
                { name: '7up',                  price: '$2,95', img: '/img/cafe/menu/7up.webp' },
              ],
            },
          ],
        },
          ...
          subs: [
            ...
            },
            {
              ...
              items: [
                ...
                { name: 'Latte',            price: '$3,30', img: '/img/cafe/menu/cafe-latte-6oz.webp' },
                { name: 'Latte Vainilla',   price: '$3,55', img: FALLBACK },
                { name: 'Latte Salt Caramel', price: '$3,50', img: FALLBACK },
                { name: 'Cappuccino',       price: '$3,25', img: '/img/cafe/menu/cafe-cappuccino-6oz.webp' },
                { name: 'Pistacchino',      price: '$6,00', img: FALLBACK },
                { name: 'Moka',             price: '$4,00', img: '/img/cafe/menu/cafe-moka.webp' },
              ],
            },
            {
              name: 'Café 4oz',
